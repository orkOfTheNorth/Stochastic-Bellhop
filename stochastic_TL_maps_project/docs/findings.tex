...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{shallow_water/Normal_1pct/figures/shadow_70_MC_vs_Delta.png}
    \caption{MC vs.\ Delta}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{shallow_water/Normal_1pct/figures/shadow_70_MC_vs_DeltaLN3.png}
    \caption{MC vs.\ Delta--LN3}
  \end{subfigure}\\[8pt]
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{shallow_water/Normal_1pct/figures/shadow_70_MC_vs_LN3.png}
    \caption{MC vs.\ LN3}
  \end{subfigure}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    Deep water    & $\dagger$ & $\dagger$ & $\dagger$ \\
    Shallow water & $\dagger$ & $\dagger$ & $\dagger$ \\
    Upslope       & $\dagger$ & $\dagger$ & $\dagger$ \\
    Downslope     & $\dagger$ & $\dagger$ & $\dagger$ \\
    \bottomrule
  \end{tabular}
\end{table}
