%% run_MC.m  –  Monte Carlo UQ | Scenario: Shallow Water
% Bathymetry: flat 50 m, range 5 km.  N=50, ~2-3 s/run → ~12-18 min total.
...
SCN_LABEL='Shallow Water (50m flat, 5km)';
bathy_type='const_50'; maxR=5000;
