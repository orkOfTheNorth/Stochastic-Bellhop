...
\begin{figure}[H]
  ...
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{baseline/Uniform_1pct/figures/shadow_70_MC_vs_LN3.png}
    \caption{MC vs.\ LN3}
  \end{subfigure}
  \caption{Delta vs.\ MC vs.\ Delta--LN3 shadow-probability comparison
           ...
           MC (baseline scenario, Uniform\,1\%, $z_S$ perturbation).
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{downslope/Uniform_5pct/figures/shadow_70_MC_vs_Delta_svp.png}
    \caption{MC vs.\ Delta}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{downslope/Uniform_5pct/figures/shadow_70_MC_vs_DeltaLN3_svp.png}
    \caption{MC vs.\ Delta--LN3}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{downslope/Uniform_5pct/figures/shadow_70_MC_vs_LN3_svp.png}
    \caption{MC vs.\ LN3}
  \end{subfigure}
  \caption{Delta vs.\ MC vs.\ Delta--LN3 shadow-probability comparison
           ($P(\TL > 70\,\text{dB})$) where the 1\textsuperscript{st}-order Delta
           \emph{fails} (downslope scenario, Uniform\,5\%, SVP perturbation).
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{downslope/Uniform_5pct/figures/pce_convergence_downslope_Uniform_5pct.png}
    \caption{Downslope, Uniform\,5\% --- strongly nonlinear; no parameter converges by $K=10$.}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{baseline/Normal_10pct/figures/pce_convergence_baseline_Normal_10pct.png}
    \caption{Baseline, Normal\,10\% --- freq converges at $K^*{=}1$; $z_S$ and SVP do not.}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{baseline/Normal_10pct/figures/pce_convergence_baseline_Normal_10pct.png}
    \caption{Baseline, Normal\,10\%: freq converges immediately ($K^*{=}1$);
             $z_S$ and SVP show no convergence within $K{=}10$.}
    \label{fig:cv_zS}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\linewidth]{downslope/Uniform_5pct/figures/pce_convergence_downslope_Uniform_5pct.png}
    \caption{Downslope, Uniform\,5\%: none of the three parameters converge ---
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{deep_water/Normal_10pct/figures/empirical_freq.png}
    \caption{Deep water, Normal\,10\%, freq: MC empirical shadow-probability and
             variance maps.}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\linewidth]{deep_water/Normal_10pct/figures/empirical_zS.png}
